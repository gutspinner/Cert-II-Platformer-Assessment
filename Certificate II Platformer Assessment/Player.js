...
Player.prototype.update = function(deltaTime)
{
	...
	context.fillText(Math.ceil(bulletsCount), 525, 30)
	...
	if (keyboard.isKeyDown(keyboard.KEY_Z) && bulletsCount > 0)
	{
	...
	if (keyboard.isKeyDown(keyboard.KEY_ENTER) && !jump && bulletsCount > 0)
	{
		this.shooting = true;
		if (this.direction == LEFT)
		{
